            ...
            <div className="about">
                ...
                <div className="rightB">
                    ...
                    <div className="body">
                        ...
                        <div><div className="wings"></div>In my free time I enjoy being with my family, getting outside to shoot hoops, and catching a hockey game (Go Wings!).</div>
                        ...
                        <p>As I got older, I began to move into web development and freelance projects to continue learning and expanding my skill set. I started an advertising software business in my college years and quickly learned about production code and the business world.</p>
